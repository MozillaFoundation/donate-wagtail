...
function setupBraintree() {
    var paymentForm = document.getElementById('payments__braintree-form'),
        ...
        loadingErrorMsg = 'An error occurred. Please reload the page or try again later.',
        ...
        braintreeParams = JSON.parse(document.getElementById('payments__braintree-params').textContent);
                ...
                hostedFields.create(options, function (hostedFieldsErr, hostedFieldsInstance) {
                    ...
                    submitButton.addEventListener('click', function(e){
                        ...
                        if(formValid){
                            ...
                            showErrorMessage('Some of the fields below are invalid. Please correct the invalid fields and try again.');
                        }
                    });
                });
            }
