...
const postCodeErrorMessage = document.querySelector(
  ".error-message__post-code"
);
...
// Checking whether or not the country exists in array of countries. Will move the array to external file soon
function postCodeCheck(selectedCountry) {
  const selectedCountrysName =
    countrySelector.options[countrySelector.selectedIndex].text;
  // Finding the country object in the array, to check if it has a "Post-code" key.
