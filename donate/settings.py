...
env = environ.Env(
    ...
    WAGTAILLOCALIZE_PONTOON_GIT_SSH_PUBLIC_KEY=(str, ''),
...
WAGTAILLOCALIZE_PONTOON_GIT_SSH_PUBLIC_KEY = base64.b64decode(env('WAGTAILLOCALIZE_PONTOON_GIT_SSH_PUBLIC_KEY'))
