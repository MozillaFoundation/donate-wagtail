...
env = environ.Env(
    ...
    THUNDERBIRD_MC_API_KEY=(str, None),
    THUNDERBIRD_MC_SERVER=(str, None),
    THUNDERBIRD_MC_LIST_ID=(str, None),
    RANDOM_SEED=(int, None),
    RECAPTCHA_SECRET_KEY=(str, ''),
    RECAPTCHA_SECRET_KEY_CHECKBOX=(str, ''),
    RECAPTCHA_SITE_KEY=(str, ''),           # main page invisible recaptcha
    RECAPTCHA_SITE_KEY_CHECKBOX=(str, ''),  # card-donation visible recaptcha
    RECAPTCHA_SITE_KEY_REGULAR=(str, ''),   # help page checkbox recaptcha
